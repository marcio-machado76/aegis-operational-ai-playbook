...
- **Juiz × gerador separados:** juiz = `openai:chat:gpt-5.4-mini`; gerador da análise no gate =
  `anthropic:messages:claude-haiku-4-5-20251001` (evita autoavaliação).
...
- **Gate em ação:** rodado contra os artefatos do Cerebro (CP03), a análise gerada pelo
  Claude Haiku foi avaliada pelo juiz e **aprovada** (PASS) — o gate roda automático a cada execução.
